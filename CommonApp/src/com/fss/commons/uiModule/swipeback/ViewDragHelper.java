...
package com.fss.commons.uiModule.swipeback;
...
public class ViewDragHelper {
     ...
     * callback's
     * {@link com.fss.commons.uiModule.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.fss.commons.uiModule.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link com.fss.commons.uiModule.swipeback.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)}
     ...
     * {@link com.fss.commons.uiModule.swipeback.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     * 
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
