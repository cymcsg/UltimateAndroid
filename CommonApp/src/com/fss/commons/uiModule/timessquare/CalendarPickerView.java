...
package com.fss.commons.uiModule.timessquare;
...
import com.fss.commons.commonUtils.logUtils.Logs;
import com.fss.commons.uiModule.timessquare.MonthCellDescriptor.RangeState;
 ...
 * {@link com.fss.commons.uiModule.timessquare.CalendarPickerView.FluentInitializer} methods returned.  The currently selected date can be retrieved with
...
public class CalendarPickerView extends ListView {
     ...
     * <p/>
     * This will implicitly set the {@link com.fss.commons.uiModule.timessquare.CalendarPickerView.SelectionMode} to {@link com.fss.commons.uiModule.timessquare.CalendarPickerView.SelectionMode#SINGLE}.  If you
     * want a different selection mode, use {@link com.fss.commons.uiModule.timessquare.CalendarPickerView.FluentInitializer#inMode(com.fss.commons.uiModule.timessquare.CalendarPickerView.SelectionMode)} on the
     * {@link com.fss.commons.uiModule.timessquare.CalendarPickerView.FluentInitializer} this method returns.
     * <p/>
    ...
    public class FluentInitializer {
        /**
         * Override the {@link com.fss.commons.uiModule.timessquare.CalendarPickerView.SelectionMode} from the default ({@link com.fss.commons.uiModule.timessquare.CalendarPickerView.SelectionMode#SINGLE}).
         */
         ...
         * pass in multiple dates and haven't already called {@link #inMode(com.fss.commons.uiModule.timessquare.CalendarPickerView.SelectionMode)}.
         */
    ...
    private void scrollToSelectedMonth(final int selectedIndex, final boolean smoothScroll) {
        post(new Runnable() {
            @Override
            public void run() {
                Logs.d("Scrolling to position %d" + selectedIndex);
    ...
    public void unfixDialogDimens() {
        Logs.d("Reset the fixed dimensions to allow for re-measurement");
        // Fix the layout height/width after the dialog has been shown.
    ...
    /**
     * Select a new date.  Respects the {@link com.fss.commons.uiModule.timessquare.CalendarPickerView.SelectionMode} this CalendarPickerView is configured
     * with: if you are in {@link com.fss.commons.uiModule.timessquare.CalendarPickerView.SelectionMode#SINGLE}, the previously selected date will be
     * un-selected.  In {@link com.fss.commons.uiModule.timessquare.CalendarPickerView.SelectionMode#MULTIPLE}, the new date will be added to the list of
     * selected dates.
     * <p/>
    ...
    List<List<MonthCellDescriptor>> getMonthCells(MonthDescriptor month, Calendar startCal) {
        ...
        while ((cal.get(MONTH) < month.getMonth() + 1 || cal.get(YEAR) < month.getYear()) //
            ...
            Logs.d("Building week row starting at %s"+cal.getTime());
     ...
     *
     * @see #setOnDateSelectedListener(com.fss.commons.uiModule.timessquare.CalendarPickerView.OnDateSelectedListener)
     */
     ...
     * listener will not be notified.
     *
     * @see #setOnInvalidDateSelectedListener(com.fss.commons.uiModule.timessquare.CalendarPickerView.OnInvalidDateSelectedListener)
     */
     ...
     *
     * @see #setDateSelectableFilter(com.fss.commons.uiModule.timessquare.CalendarPickerView.DateSelectableFilter)
     */
