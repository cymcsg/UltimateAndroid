 ...
 */
package com.fss.commons.uiModule.enhanceListView;
...
import com.fss.commons.R;
import com.fss.commons.uiModule.nineoldandroids.animation.Animator;
import com.fss.commons.uiModule.nineoldandroids.animation.AnimatorListenerAdapter;
import com.fss.commons.uiModule.nineoldandroids.animation.ValueAnimator;
import com.fss.commons.uiModule.nineoldandroids.view.ViewHelper;
import com.fss.commons.uiModule.nineoldandroids.view.ViewPropertyAnimator;
...
public class EnhancedListView extends ListView {
     ...
     * Pass this to {@link #setUndoStyle(com.fss.commons.uiModule.enhanceListView.EnhancedListView.UndoStyle)}
     ...
     * Use {@link #setSwipeDirection(com.fss.commons.uiModule.enhanceListView.EnhancedListView.SwipeDirection)}
    ...
    /**
     * The callback interface used by {@link #setShouldSwipeCallback(com.fss.commons.uiModule.enhanceListView.EnhancedListView.OnShouldSwipeCallback)}
    ...
    public interface OnShouldSwipeCallback {
         ...
         *
         * @param listView The {@link com.fss.commons.uiModule.enhanceListView.EnhancedListView} the item is wiping from.
    ...
    /**
     * The callback interface used by {@link #setDismissCallback(com.fss.commons.uiModule.enhanceListView.EnhancedListView.OnDismissCallback)}
    ...
    public interface OnDismissCallback {
         ...
         * depends on your data and adapter, the {@link com.fss.commons.uiModule.enhanceListView.EnhancedListView}
         ...
         * of {@link com.fss.commons.uiModule.enhanceListView.EnhancedListView.Undoable} from this method.
         ...
         *
         * @param listView The {@link com.fss.commons.uiModule.enhanceListView.EnhancedListView} the item has been deleted from.
         * @param position The position of the item to delete from your adapter.
         * @return An {@link com.fss.commons.uiModule.enhanceListView.EnhancedListView.Undoable}, if you want
     ...
     * {@link com.fss.commons.uiModule.enhanceListView.EnhancedListView.OnDismissCallback#onDismiss(com.fss.commons.uiModule.enhanceListView.EnhancedListView, int)}
     * to let the user undo the deletion you've done with your {@link com.fss.commons.uiModule.enhanceListView.EnhancedListView.OnDismissCallback}.
    ...
    public abstract static class Undoable {
         ...
         * {@link com.fss.commons.uiModule.enhanceListView.EnhancedListView.OnDismissCallback#onDismiss(com.fss.commons.uiModule.enhanceListView.EnhancedListView, int)} and reinsert
         ...
         * (whereas in {@link com.fss.commons.uiModule.enhanceListView.EnhancedListView.OnDismissCallback#onKeyDown(int, android.view.KeyEvent)}
     ...
     * {@link com.fss.commons.uiModule.enhanceListView.EnhancedListView.OnDismissCallback#onDismiss(com.fss.commons.uiModule.enhanceListView.EnhancedListView, int)}
     * of the given {@link com.fss.commons.uiModule.enhanceListView.EnhancedListView} will be called. To enable
     * <i>undo</i> of the deletion, return an {@link com.fss.commons.uiModule.enhanceListView.EnhancedListView.Undoable}
     * from {@link com.fss.commons.uiModule.enhanceListView.EnhancedListView.OnDismissCallback#onDismiss(com.fss.commons.uiModule.enhanceListView.EnhancedListView, int)}.
     ...
     *
     * @return The {@link com.fss.commons.uiModule.enhanceListView.EnhancedListView}
     * @throws IllegalStateException when you haven't passed an {@link com.fss.commons.uiModule.enhanceListView.EnhancedListView.OnDismissCallback}
     *                                         to {@link #setDismissCallback(com.fss.commons.uiModule.enhanceListView.EnhancedListView.OnDismissCallback)} before calling this
     *                                         method.
     */
     ...
     *
     * @return This {@link com.fss.commons.uiModule.enhanceListView.EnhancedListView}
     */
    ...
    /**
     * Sets the undo style of this list. See the javadoc of {@link com.fss.commons.uiModule.enhanceListView.EnhancedListView.UndoStyle}
     * for a detailed explanation of the different styles. The default style (if you never call this
     * method) is {@link com.fss.commons.uiModule.enhanceListView.EnhancedListView.UndoStyle#SINGLE_POPUP}.
     *
     ...
     * By default this is set to {@link com.fss.commons.uiModule.enhanceListView.EnhancedListView.SwipeDirection#BOTH} so that an item
     ...
     * {@link com.fss.commons.uiModule.enhanceListView.EnhancedListView.Undoable#discard()} might not be called for several items, what might
     ...
     * @throws IllegalStateException     when this method is called before an {@link com.fss.commons.uiModule.enhanceListView.EnhancedListView.OnDismissCallback}
     *                                             is set via {@link #setDismissCallback(com.fss.commons.uiModule.enhanceListView.EnhancedListView.OnDismissCallback)}.
     */
...
//                            1f - 2f * Math.abs(deltaX) / mViewWidth)));
     ...
     * {@link #setSwipeDirection(com.fss.commons.uiModule.enhanceListView.EnhancedListView.SwipeDirection)}
     *
