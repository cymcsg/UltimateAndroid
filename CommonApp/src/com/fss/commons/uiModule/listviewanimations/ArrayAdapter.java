 ...
 */
package com.fss.commons.uiModule.listviewanimations;

import android.widget.BaseAdapter;
import com.fss.commons.uiModule.listviewanimations.itemmanipulation.AnimateAdditionAdapter;
import com.fss.commons.uiModule.listviewanimations.widget.DynamicListView;
...
public abstract class ArrayAdapter<T> extends BaseAdapter implements List<T>, DynamicListView.Swappable, AnimateAdditionAdapter.Insertable<T> {
    ...
    /**
     * Creates a new {@link com.fss.commons.uiModule.listviewanimations.ArrayAdapter} using given {@code List} , or an empty {@code List}  if objects == null.
     */
    ...
    /**
     * Creates a new {@link com.fss.commons.uiModule.listviewanimations.ArrayAdapter}, using (a copy of) given {@code List} , or an empty {@code List}  if objects = null.
