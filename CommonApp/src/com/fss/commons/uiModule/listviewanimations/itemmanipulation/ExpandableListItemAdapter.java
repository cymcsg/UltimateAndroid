...
import com.fss.commons.uiModule.listviewanimations.ListViewSetter;
...
public abstract class ExpandableListItemAdapter<T> extends ArrayAdapter<T> implements ListViewSetter {
    ...
    /**
     * Creates a new {@link com.fss.commons.uiModule.listviewanimations.itemmanipulation.ExpandableListItemAdapter} with the specified list,
    ...
    /**
     * Set the {@link com.fss.commons.uiModule.listviewanimations.itemmanipulation.ExpandCollapseListener} that should be notified of expand / collapse events.
     */
