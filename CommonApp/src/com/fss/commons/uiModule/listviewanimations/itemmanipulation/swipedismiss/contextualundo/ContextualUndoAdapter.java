 ...
 */
package com.fss.commons.uiModule.listviewanimations.itemmanipulation.swipedismiss.contextualundo;
...
import com.fss.commons.uiModule.nineoldandroids.animation.ObjectAnimator;
import com.fss.commons.uiModule.listviewanimations.BaseAdapterDecorator;
import com.fss.commons.uiModule.listviewanimations.util.AdapterViewUtil;
...
import static com.fss.commons.uiModule.nineoldandroids.view.ViewHelper.setAlpha;
import static com.fss.commons.uiModule.nineoldandroids.view.ViewHelper.setTranslationX;
import static com.fss.commons.uiModule.nineoldandroids.view.ViewPropertyAnimator.animate;
 ...
 * <p>
 * Usage: <br>
 * * Create a new instance of this class providing the {@link android.widget.BaseAdapter} to wrap, the undo layout, the undo button id and a {@link com.fss.commons.uiModule.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoAdapter.DeleteItemCallback}, optionally a delay time millis,
...
public class ContextualUndoAdapter extends BaseAdapterDecorator implements ContextualUndoListViewTouchListener.Callback {
     ...
     * @param deleteItemCallback The {@link com.fss.commons.uiModule.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoAdapter.DeleteItemCallback} which is called when an item should be deleted from your collection.
     */
     ...
     * @param deleteItemCallback The {@link com.fss.commons.uiModule.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoAdapter.DeleteItemCallback} which is called when an item should be deleted from your collection.
     * @param countDownFormatter The {@link com.fss.commons.uiModule.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoAdapter.CountDownFormatter} which provides text to be shown in the {@link android.widget.TextView} as specified by countDownTextViewResId
     */
    ...
    /**
     * Cancels the count down, and removes any item that was swiped away, without animating. Will cause {@link com.fss.commons.uiModule.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoAdapter.DeleteItemCallback#deleteItem(int)} to be called.
     */
    ...
    /**
     * Removes any item that was swiped away, animating the removal (collapsing the item). {@link com.fss.commons.uiModule.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoAdapter.DeleteItemCallback#deleteItem(int)} to be called.
     */
    ...
    /**
     * Cancel the count down. This will not cause the {@link com.fss.commons.uiModule.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoAdapter.DeleteItemCallback#deleteItem(int)} to be called. Use {@link #removePendingItem()} for that instead.
     */
