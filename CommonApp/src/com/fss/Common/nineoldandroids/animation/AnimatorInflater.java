...
public class AnimatorInflater {
    ...
    /**
     * Loads an {@link com.fss.Common.nineoldandroids.animation.Animator} object from a resource
     *
    ...
    private static Animator createAnimatorFromXml(Context c, XmlPullParser parser,
            AttributeSet attrs, com.fss.Common.nineoldandroids.animation.AnimatorSet parent, int sequenceOrdering)
            throws XmlPullParserException, IOException {
        ...
        while (((type=parser.next()) != XmlPullParser.END_TAG || parser.getDepth() > depth)
            ...
            if (name.equals("objectAnimator")) {
                ...
                anim = new com.fss.Common.nineoldandroids.animation.AnimatorSet();
                ...
                createAnimatorFromXml(c, parser, attrs, (com.fss.Common.nineoldandroids.animation.AnimatorSet) anim,  ordering);
                a.recycle();
            } else {
