 ...
 *  *****************************************************************************
 */
package com.marshalchen.common.demoofui.recyclerviewitemanimator;
...
public class SimpleAdapter extends RecyclerView.Adapter<SimpleAdapter.SimpleViewHolder> {
    ...
    public SimpleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(mContext).inflate(R.layout.recycler_view_simple_item, parent, false);
