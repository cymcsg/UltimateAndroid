...
public class Launcher extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //  R.layout.drag_sort_listview_launcher_item, R.id.text, mActivities);
    ...
    private class MyAdapter extends ArrayAdapter<ActivityInfo> {
      MyAdapter() {
        super(Launcher.this, R.layout.drag_sort_listview_launcher_item, R.id.activity_title, mActivities);
      }
