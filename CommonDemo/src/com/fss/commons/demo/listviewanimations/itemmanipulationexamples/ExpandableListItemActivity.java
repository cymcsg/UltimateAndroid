...
import com.fss.commons.uiModule.listviewanimations.itemmanipulation.ExpandableListItemAdapter;
import com.fss.commons.uiModule.listviewanimations.swinginadapters.prepared.AlphaInAnimationAdapter;

import java.util.List;

public class ExpandableListItemActivity extends ListAnimationListActivity {
    ...
    private static class MyExpandableListItemAdapter extends ExpandableListItemAdapter<Integer> {
        ...
        public View getTitleView(final int position, final View convertView, final ViewGroup parent) {
            ...
            //tv.setText(mContext.getString(R.string.elv_undo, getItem(position)));
            tv.setText("111");
            return tv;
        }
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        getMenuInflater().inflate(R.menu.list_anim_menu_expandablelistitem, menu);
