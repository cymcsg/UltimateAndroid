// @author Bhavya Mehta
package com.fss.commons.demo.listviewfilter.ui;
...
public class ListFilter extends View {
    ...
    public ListFilter(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
    }


    public ListFilter(Context context, AttributeSet attrs, int defStyle) {
