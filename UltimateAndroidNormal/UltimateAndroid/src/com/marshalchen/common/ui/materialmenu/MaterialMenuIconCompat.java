...
/**
 * A helper class for implementing {@link com.marshalchen.common.ui.materialmenu.MaterialMenuDrawable}
 * as an {@link android.support.v7.app.ActionBar} Compat icon.
 * <p/>
 * In order to preserve default ActionBar icon click state call {@link com.marshalchen.common.ui.materialmenu.MaterialMenuBase#setNeverDrawTouch(boolean)}.
