...
package com.marshalchen.common.demoofui.twowayview;
...
import com.marshalchen.common.uimodule.twowayview.widget.SpannableGridLayoutManager;
import com.marshalchen.common.uimodule.twowayview.widget.StaggeredGridLayoutManager;
import com.marshalchen.common.uimodule.twowayview.widget.TwoWayView;
...
public class LayoutAdapter extends RecyclerView.Adapter<LayoutAdapter.SimpleViewHolder> {
    ...
    public SimpleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(mContext).inflate(R.layout.two_way_view_item, parent, false);
