    ...
    protected void moveLayoutToPosition(int position, int offset, Recycler recycler, State state) {
        ...
        for (int i = 0; i <= position; i++) {
            ...
            if (entry == null) {
                ...
                entry = (SpannableItemEntry) cacheChildLaneAndSpan(child, TwoWayLayoutManager.Direction.END);
            }
            ...
            lanes.getChildFrame(mTempRect, getChildWidth(entry.colSpan),
                    getChildHeight(entry.rowSpan), mTempLaneInfo, TwoWayLayoutManager.Direction.END);
