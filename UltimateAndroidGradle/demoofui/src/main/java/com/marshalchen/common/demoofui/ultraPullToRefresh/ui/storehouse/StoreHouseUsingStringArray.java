package com.marshalchen.common.demoofui.ultraPullToRefresh.ui.storehouse;
...
public class StoreHouseUsingStringArray extends TitleBaseFragment {
    ...
    protected View createView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.ultra_pull_refresh_fragment_storehouse_header, null);
