...
import com.marshalchen.common.uimodule.roundcornerprogressbar.IconRoundCornerProgressBar;
import com.marshalchen.common.uimodule.roundcornerprogressbar.RoundCornerProgressBar;
import com.marshalchen.common.uimodule.roundcornerprogressbar.TextRoundCornerProgressBar;


public class RoundCornerProgressBarActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.round_corner_progress_bar_activity_activity_main);

        progressOne = (IconRoundCornerProgressBar) findViewById(R.id.progress_one);
        progressOne.setProgressColor(getResources().getColor(R.color.round_corner_progress_bar_custom_progress_blue_progress));
        progressOne.setHeaderColor(getResources().getColor(R.color.round_corner_progress_bar_custom_progress_blue_header));
        progressOne.setBackgroundColor(getResources().getColor(R.color.round_corner_progress_bar_custom_progress_background));
        ...
        progressTwo.setBackgroundColor(getResources().getColor(R.color.round_corner_progress_bar_custom_progress_background));
    ...
    private void updateProgressTwoColor() {
        if(progress2 <= 3) {
            progressTwo.setProgressColor(getResources().getColor(R.color.round_corner_progress_bar_custom_progress_red_progress));
        } else if(progress2 > 3 && progress2 <= 6) {
            progressTwo.setProgressColor(getResources().getColor(R.color.round_corner_progress_bar_custom_progress_orange_progress));
        } else if(progress2 > 6) {
            progressTwo.setProgressColor(getResources().getColor(R.color.round_corner_progress_bar_custom_progress_green_progress));
        }
    }
}
