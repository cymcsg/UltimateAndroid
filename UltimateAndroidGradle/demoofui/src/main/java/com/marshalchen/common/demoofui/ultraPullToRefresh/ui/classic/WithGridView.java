...
import com.marshalchen.common.demoofui.ultraPullToRefresh.data.DemoRequestData;
...
public class WithGridView extends TitleBaseFragment {
    ...
    public View createView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View contentView = inflater.inflate(R.layout.ultra_pull_refresh_fragment_classic_header_with_gridview, null);
    ...
    private class ViewHolder extends ViewHolderBase<JsonData> {
        ...
        public View createView(LayoutInflater inflater) {
            View view = LayoutInflater.from(getActivity()).inflate(R.layout.ultra_pull_refresh_with_grid_view_item_image_list_grid, null);
