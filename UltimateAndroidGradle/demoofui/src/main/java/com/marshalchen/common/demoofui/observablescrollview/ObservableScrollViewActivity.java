...
public class ObservableScrollViewActivity extends ActionBarActivity implements AdapterView.OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listView.setAdapter(new SimpleAdapter(this, getData(),
                R.layout.observable_scroll_view_list_item_main,
