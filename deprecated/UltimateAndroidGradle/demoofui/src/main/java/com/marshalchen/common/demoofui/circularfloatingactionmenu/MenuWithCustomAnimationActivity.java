...
public class MenuWithCustomAnimationActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.circular_floating_menu_activity_menu_with_custom_animation);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.circular_floating_menu_menu_with_custom_animation, menu);
        return true;
    }
