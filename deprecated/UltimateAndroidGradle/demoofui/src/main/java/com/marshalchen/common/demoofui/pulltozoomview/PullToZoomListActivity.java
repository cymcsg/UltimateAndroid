...
import com.marshalchen.common.uimodule.pulltozoomview.PullToZoomListView;
...
public class PullToZoomListActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pull_to_zoom_activity_pull_to_zoom_list_view);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.pull_to_zoom_list_view, menu);
        return true;
    }
